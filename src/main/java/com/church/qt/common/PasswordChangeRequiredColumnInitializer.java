...
public class PasswordChangeRequiredColumnInitializer {
    ...
    void ensurePasswordChangeRequiredColumn() {
        ensureColumn("teachers", "password_change_required", "boolean not null default false");
    }
    ...
    private boolean columnExists(String tableName, String columnName) {
        try (Connection connection = dataSource.getConnection()) {
            ...
            throw new IllegalStateException("password_change_required 칼럼 존재 여부를 확인할 수 없습니다.", e);
        }
    }
