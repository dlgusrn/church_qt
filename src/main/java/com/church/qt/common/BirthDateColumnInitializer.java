...
public class BirthDateColumnInitializer {
    ...
    public void initialize() {
        ensureBirthDateColumns();
    }

    void ensureBirthDateColumns() {
        ensureColumn("teachers", "birth_date", "varchar(8) null");
        ensureColumn("students", "birth_date", "varchar(8) null");
    }
    ...
    private boolean columnExists(String tableName, String columnName) {
        try (Connection connection = dataSource.getConnection()) {
            ...
            throw new IllegalStateException("birth_date 칼럼 존재 여부를 확인할 수 없습니다.", e);
        }
    }
